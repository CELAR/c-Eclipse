 ...
 * <ul>
 *   <li>{@link eu.celar.tosca.ConstraintsType#getConstraint <em>Constraint</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.celar.tosca.ToscaPackage#getConstraintsType()
...
public interface ConstraintsType extends EObject
{
   ...
   * @see eu.celar.tosca.ToscaPackage#getConstraintsType_Constraint()
