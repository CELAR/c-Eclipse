...
import eu.celar.tosca.CapabilityDefinitionsType;
import eu.celar.tosca.ConstraintsType;
import eu.celar.tosca.ConstraintsType1;
import eu.celar.tosca.DefinitionsType;
import eu.celar.tosca.DerivedFromType;
import eu.celar.tosca.DerivedFromType1;
import eu.celar.tosca.DerivedFromType2;
import eu.celar.tosca.DocumentRoot;
import eu.celar.tosca.ExcludeType;
import eu.celar.tosca.ExtensionsType;
import eu.celar.tosca.ImplementationArtifactType;
import eu.celar.tosca.IncludeType;
import eu.celar.tosca.InputParametersType;
import eu.celar.tosca.InputParametersType1;
import eu.celar.tosca.InstanceStateType;
import eu.celar.tosca.InterfacesType;
import eu.celar.tosca.InterfacesType1;
import eu.celar.tosca.MaxInstancesTypeMember1;
import eu.celar.tosca.NodeOperationType;
import eu.celar.tosca.NodeTypeReferenceType;
import eu.celar.tosca.OutputParametersType;
import eu.celar.tosca.OutputParametersType1;
import eu.celar.tosca.PlanModelReferenceType;
import eu.celar.tosca.PlanModelType;
import eu.celar.tosca.PlanType;
...
import eu.celar.tosca.PropertyConstraintsType;
import eu.celar.tosca.PropertyConstraintsType1;
import eu.celar.tosca.PropertyMappingsType;
import eu.celar.tosca.RelationshipConstraintType;
import eu.celar.tosca.RelationshipConstraintsType;
import eu.celar.tosca.RelationshipOperationType;
import eu.celar.tosca.RequirementDefinitionsType;
import eu.celar.tosca.RequirementsType;
...
import eu.celar.tosca.TRequirement;
...
import eu.celar.tosca.TTag;
import eu.celar.tosca.TTags;
import eu.celar.tosca.TTopologyElementInstanceStates;
import eu.celar.tosca.TTopologyTemplate;
import eu.celar.tosca.TargetElementType;
import eu.celar.tosca.TargetInterfacesType;
import eu.celar.tosca.ToscaFactory;
import eu.celar.tosca.ToscaPackage;
import eu.celar.tosca.TypesType;
import eu.celar.tosca.UpperBoundTypeMember1;
import eu.celar.tosca.UpperBoundTypeMember11;
import eu.celar.tosca.ValidSourceType;
import eu.celar.tosca.ValidTargetType;

import eu.celar.tosca.util.ToscaValidator;
...
public class ToscaPackageImpl extends EPackageImpl implements ToscaPackage
{
   ...
   * @see eu.celar.tosca.ToscaPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getTDeploymentArtifact_ArtifactRef(), theXMLTypePackage.getString(), "artifactRef", null, 0, 1, TDeploymentArtifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
