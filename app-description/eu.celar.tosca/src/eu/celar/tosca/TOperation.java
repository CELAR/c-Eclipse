 ...
 * <ul>
 *   <li>{@link eu.celar.tosca.TOperation#getInputParameters <em>Input Parameters</em>}</li>
 *   <li>{@link eu.celar.tosca.TOperation#getOutputParameters <em>Output Parameters</em>}</li>
 *   <li>{@link eu.celar.tosca.TOperation#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.celar.tosca.ToscaPackage#getTOperation()
...
public interface TOperation extends TExtensibleElements
{
   ...
   * @see eu.celar.tosca.ToscaPackage#getTOperation_InputParameters()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TOperation#getInputParameters <em>Input Parameters</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTOperation_OutputParameters()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TOperation#getOutputParameters <em>Output Parameters</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setName(String)
   * @see eu.celar.tosca.ToscaPackage#getTOperation_Name()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TOperation#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
