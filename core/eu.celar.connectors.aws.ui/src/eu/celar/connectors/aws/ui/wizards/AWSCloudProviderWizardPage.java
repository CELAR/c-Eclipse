...
import eu.celar.connectors.aws.AWSCloudProviderCreator;
import eu.celar.connectors.aws.AWSCloudProviderProperties;
...
public class AWSCloudProviderWizardPage extends WizardPage {
  ...
  private static final String WIZARD_PAGE_ID = "eu.celar.connectors.aws.ui.awsCloudProviderWizardPage"; //$NON-NLS-1$
