 ...
 * <ul>
 *   <li>{@link eu.celar.tosca.TConstraint#getAny <em>Any</em>}</li>
 *   <li>{@link eu.celar.tosca.TConstraint#getConstraintType <em>Constraint Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.celar.tosca.ToscaPackage#getTConstraint()
...
public interface TConstraint extends EObject
{
   ...
   * @see eu.celar.tosca.ToscaPackage#getTConstraint_Any()
   ...
   * @see eu.celar.tosca.ToscaPackage#getTConstraint_ConstraintType()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TConstraint#getConstraintType <em>Constraint Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
