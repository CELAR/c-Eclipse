 ...
 * <ul>
 *   <li>{@link eu.celar.tosca.PlanModelType#getAny <em>Any</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.celar.tosca.ToscaPackage#getPlanModelType()
...
public interface PlanModelType extends EObject
{
   ...
   * @see eu.celar.tosca.ToscaPackage#getPlanModelType_Any()
