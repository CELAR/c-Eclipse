 ...
 * <ul>
 *   <li>{@link eu.celar.tosca.TNodeTemplate#getRequirements <em>Requirements</em>}</li>
 *   <li>{@link eu.celar.tosca.TNodeTemplate#getCapabilities <em>Capabilities</em>}</li>
 *   <li>{@link eu.celar.tosca.TNodeTemplate#getPolicies <em>Policies</em>}</li>
 *   <li>{@link eu.celar.tosca.TNodeTemplate#getDeploymentArtifacts <em>Deployment Artifacts</em>}</li>
 *   <li>{@link eu.celar.tosca.TNodeTemplate#getMaxInstances <em>Max Instances</em>}</li>
 *   <li>{@link eu.celar.tosca.TNodeTemplate#getMinInstances <em>Min Instances</em>}</li>
 *   <li>{@link eu.celar.tosca.TNodeTemplate#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.celar.tosca.ToscaPackage#getTNodeTemplate()
...
public interface TNodeTemplate extends TEntityTemplate
{
   ...
   * @see eu.celar.tosca.ToscaPackage#getTNodeTemplate_Requirements()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TNodeTemplate#getRequirements <em>Requirements</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTNodeTemplate_Capabilities()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TNodeTemplate#getCapabilities <em>Capabilities</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTNodeTemplate_Policies()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TNodeTemplate#getPolicies <em>Policies</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTNodeTemplate_DeploymentArtifacts()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TNodeTemplate#getDeploymentArtifacts <em>Deployment Artifacts</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTNodeTemplate_MaxInstances()
   * @model default="1" unsettable="true" dataType="eu.celar.tosca.MaxInstancesType"
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TNodeTemplate#getMaxInstances <em>Max Instances</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Unsets the value of the '{@link eu.celar.tosca.TNodeTemplate#getMaxInstances <em>Max Instances</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetMaxInstances()
   * @see #getMaxInstances()
  ...
  /**
   * Returns whether the value of the '{@link eu.celar.tosca.TNodeTemplate#getMaxInstances <em>Max Instances</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTNodeTemplate_MinInstances()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TNodeTemplate#getMinInstances <em>Min Instances</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Unsets the value of the '{@link eu.celar.tosca.TNodeTemplate#getMinInstances <em>Min Instances</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetMinInstances()
   * @see #getMinInstances()
  ...
  /**
   * Returns whether the value of the '{@link eu.celar.tosca.TNodeTemplate#getMinInstances <em>Min Instances</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setName(String)
   * @see eu.celar.tosca.ToscaPackage#getTNodeTemplate_Name()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TNodeTemplate#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
