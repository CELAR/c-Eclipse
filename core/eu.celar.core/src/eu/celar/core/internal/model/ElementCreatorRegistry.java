 ...
 * of the <code>eu.celar.core.cloudElementCreator</code> extension point and
  ...
  implements IElementCreatorRegistry, IRegistryEventListener
{
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.model.IElementCreatorRegistry#getConfigurations()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.model.IElementCreatorRegistry#getConfigurations(java.lang.Class, java.lang.Class)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.model.IElementCreatorRegistry#getCreators()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.model.IElementCreatorRegistry#getCreator(java.lang.Object, java.lang.Class)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.model.IElementCreatorRegistry#getCreator(java.lang.Object, java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.model.IElementCreatorRegistry#getCreator(java.lang.Class, java.lang.Class)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.model.IElementCreatorRegistry#getCreators(java.lang.Object, java.lang.Class)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.model.IElementCreatorRegistry#getCreators(java.lang.Class, java.lang.Class)
   */
  @Override
   ...
   * <code>eu.celar.core.cloudElementCreator</code> extension point and
