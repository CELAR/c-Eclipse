...
import eu.celar.core.model.IDefaultCloudElementManager;
  ...
  extends AbstractCloudElementManager implements IDefaultCloudElementManager
{
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.model.IDefaultCloudElementManager#getDefault()
   */
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.model.IDefaultCloudElementManager#setDefault(eu.celar.core.model.ICloudElement)
   */
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.internal.model.AbstractCloudElementManager#addElement(eu.celar.core.model.ICloudElement)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.internal.model.AbstractCloudElementManager#removeElement(eu.celar.core.model.ICloudElement)
   */
  @Override
