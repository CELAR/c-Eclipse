 ...
 * <ul>
 *   <li>{@link eu.celar.tosca.impl.TNodeTemplateImpl#getRequirements <em>Requirements</em>}</li>
 *   <li>{@link eu.celar.tosca.impl.TNodeTemplateImpl#getCapabilities <em>Capabilities</em>}</li>
 *   <li>{@link eu.celar.tosca.impl.TNodeTemplateImpl#getPolicies <em>Policies</em>}</li>
 *   <li>{@link eu.celar.tosca.impl.TNodeTemplateImpl#getDeploymentArtifacts <em>Deployment Artifacts</em>}</li>
 *   <li>{@link eu.celar.tosca.impl.TNodeTemplateImpl#getMaxInstances <em>Max Instances</em>}</li>
 *   <li>{@link eu.celar.tosca.impl.TNodeTemplateImpl#getMinInstances <em>Min Instances</em>}</li>
 *   <li>{@link eu.celar.tosca.impl.TNodeTemplateImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
