 ...
 * <ul>
 *   <li>{@link eu.celar.tosca.TPlan#getPrecondition <em>Precondition</em>}</li>
 *   <li>{@link eu.celar.tosca.TPlan#getInputParameters <em>Input Parameters</em>}</li>
 *   <li>{@link eu.celar.tosca.TPlan#getOutputParameters <em>Output Parameters</em>}</li>
 *   <li>{@link eu.celar.tosca.TPlan#getPlanModel <em>Plan Model</em>}</li>
 *   <li>{@link eu.celar.tosca.TPlan#getPlanModelReference <em>Plan Model Reference</em>}</li>
 *   <li>{@link eu.celar.tosca.TPlan#getId <em>Id</em>}</li>
 *   <li>{@link eu.celar.tosca.TPlan#getName <em>Name</em>}</li>
 *   <li>{@link eu.celar.tosca.TPlan#getPlanLanguage <em>Plan Language</em>}</li>
 *   <li>{@link eu.celar.tosca.TPlan#getPlanType <em>Plan Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.celar.tosca.ToscaPackage#getTPlan()
...
public interface TPlan extends TExtensibleElements
{
   ...
   * @see eu.celar.tosca.ToscaPackage#getTPlan_Precondition()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TPlan#getPrecondition <em>Precondition</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTPlan_InputParameters()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TPlan#getInputParameters <em>Input Parameters</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTPlan_OutputParameters()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TPlan#getOutputParameters <em>Output Parameters</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTPlan_PlanModel()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TPlan#getPlanModel <em>Plan Model</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTPlan_PlanModelReference()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TPlan#getPlanModelReference <em>Plan Model Reference</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setId(String)
   * @see eu.celar.tosca.ToscaPackage#getTPlan_Id()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TPlan#getId <em>Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setName(String)
   * @see eu.celar.tosca.ToscaPackage#getTPlan_Name()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TPlan#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTPlan_PlanLanguage()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TPlan#getPlanLanguage <em>Plan Language</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTPlan_PlanType()
   * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI" required="true"
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TPlan#getPlanType <em>Plan Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
