  ...
  implements IAddFeature
{
  ...
  private static final IColorConstant E_CLASS_BACKGROUND = new ColorConstant( 255, 228, 225 );
...
//    MonitoringProbe addedClass = (MonitoringProbe) context.getNewObject();
//
...
//
//        if (o instanceof MonitoringProbe)
//            interdist = 3;
//    }
//    
//    
...
//            }
//
//            ((Shape) targetDiagrams[i]).getGraphicsAlgorithm().setY(
//                    ((Shape) targetDiagrams[i]).getGraphicsAlgorithm().getY() + 20+interdist);
//
//        }
//
//    }
...
//x, ySD - 10 + interdist, width, height);
//
