...
import eu.celar.ui.properties.IPropertiesFactory;
...
public class Extensions {
   ...
   */
  public static final String AUTH_TOKEN_UI_POINT = "eu.celar.ui.authTokenUI"; //$NON-NLS-1$
  /**
  ...
  private static final String PROPERTIES_FACTORY_POINT = "eu.celar.ui.propertiesFactory";  //$NON-NLS-1$
