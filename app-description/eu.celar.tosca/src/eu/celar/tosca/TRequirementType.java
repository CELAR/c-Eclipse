 ...
 * <ul>
 *   <li>{@link eu.celar.tosca.TRequirementType#getRequiredCapabilityType <em>Required Capability Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.celar.tosca.ToscaPackage#getTRequirementType()
...
public interface TRequirementType extends TEntityType
{
   ...
   * @see eu.celar.tosca.ToscaPackage#getTRequirementType_RequiredCapabilityType()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TRequirementType#getRequiredCapabilityType <em>Required Capability Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
