 ...
 * <ul>
 *   <li>{@link eu.celar.tosca.NodeTypeReferenceType#getTypeRef <em>Type Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.celar.tosca.ToscaPackage#getNodeTypeReferenceType()
...
public interface NodeTypeReferenceType extends EObject
{
   ...
   * @see eu.celar.tosca.ToscaPackage#getNodeTypeReferenceType_TypeRef()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.NodeTypeReferenceType#getTypeRef <em>Type Ref</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
