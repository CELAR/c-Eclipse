 ...
 * <ul>
 *   <li>{@link eu.celar.tosca.PlanType#getPlanRef <em>Plan Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.celar.tosca.ToscaPackage#getPlanType()
...
public interface PlanType extends EObject
{
   ...
   * @see eu.celar.tosca.ToscaPackage#getPlanType_PlanRef()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.PlanType#getPlanRef <em>Plan Ref</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
