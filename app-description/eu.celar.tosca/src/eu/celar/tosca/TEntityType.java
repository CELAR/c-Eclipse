 ...
 * <ul>
 *   <li>{@link eu.celar.tosca.TEntityType#getTags <em>Tags</em>}</li>
 *   <li>{@link eu.celar.tosca.TEntityType#getDerivedFrom <em>Derived From</em>}</li>
 *   <li>{@link eu.celar.tosca.TEntityType#getPropertiesDefinition <em>Properties Definition</em>}</li>
 *   <li>{@link eu.celar.tosca.TEntityType#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link eu.celar.tosca.TEntityType#getFinal <em>Final</em>}</li>
 *   <li>{@link eu.celar.tosca.TEntityType#getName <em>Name</em>}</li>
 *   <li>{@link eu.celar.tosca.TEntityType#getTargetNamespace <em>Target Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.celar.tosca.ToscaPackage#getTEntityType()
 * @model abstract="true"
...
public interface TEntityType extends TExtensibleElements
{
   ...
   * @see #setTags(TTags)
   * @see eu.celar.tosca.ToscaPackage#getTEntityType_Tags()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TEntityType#getTags <em>Tags</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTEntityType_DerivedFrom()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TEntityType#getDerivedFrom <em>Derived From</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTEntityType_PropertiesDefinition()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TEntityType#getPropertiesDefinition <em>Properties Definition</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTEntityType_Abstract()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TEntityType#getAbstract <em>Abstract</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Unsets the value of the '{@link eu.celar.tosca.TEntityType#getAbstract <em>Abstract</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetAbstract()
   * @see #getAbstract()
  ...
  /**
   * Returns whether the value of the '{@link eu.celar.tosca.TEntityType#getAbstract <em>Abstract</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTEntityType_Final()
   * @model default="no" unsettable="true"
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TEntityType#getFinal <em>Final</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Unsets the value of the '{@link eu.celar.tosca.TEntityType#getFinal <em>Final</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetFinal()
   * @see #getFinal()
  ...
  /**
   * Returns whether the value of the '{@link eu.celar.tosca.TEntityType#getFinal <em>Final</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setName(String)
   * @see eu.celar.tosca.ToscaPackage#getTEntityType_Name()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TEntityType#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.celar.tosca.ToscaPackage#getTEntityType_TargetNamespace()
  ...
  /**
   * Sets the value of the '{@link eu.celar.tosca.TEntityType#getTargetNamespace <em>Target Namespace</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
