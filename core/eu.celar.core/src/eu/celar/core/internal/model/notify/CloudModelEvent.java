 ...
 *****************************************************************************/
package eu.celar.core.internal.model.notify;
...
public class CloudModelEvent implements ICloudModelEvent {
 ...
 public CloudModelEvent( final int type,
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.model.ICloudModelEvent#getElements()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.model.ICloudModelEvent#getSource()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see eu.celar.core.model.ICloudModelEvent#getType()
   */
  @Override
  public int getType() {
    return this.type;
