...
import eu.celar.connectors.openstack.IOpenStackService;
import eu.celar.connectors.openstack.OpenStackCloudProvider;
import eu.celar.connectors.openstack.OpenStackCloudProviderCreator;
import eu.celar.connectors.openstack.OpenStackCloudProviderProperties;
import eu.celar.connectors.openstack.ui.Messages;
import eu.celar.connectors.openstack.ui.internal.Activator;
...
public class OpenStackCloudProviderWizardPage extends WizardPage {
  ...
  private static final String WIZARD_PAGE_ID = "eu.celar.connectors.openstack.ui.openstackCloudProviderWizardPage"; //$NON-NLS-1$
